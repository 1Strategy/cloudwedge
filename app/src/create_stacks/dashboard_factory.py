...
class DashboardFactory():
    def __init__(self, session, owner, resources: Dict[str, List[AWSResource]]):
        ...
        self.dashboard_name = f"cloudvelum-autogen-dashboard-{self.owner}"

        # Hold the templates that are created
        self.dashboard = {
            'stackName': f"cloudvelum-autogen-{self.owner}-dashboard-stack",
            's3TemplateKey': None,
            'template': {
                'AWSTemplateFormatVersion': "2010-09-09",
                'Description': f"CloudVelum Dashboard Stack for all resources that have owner {self.owner}. This stack is created dynamically by CloudVelum.",
                'Resources': {}
            }
        }
    ...
    def _build_frontmatter(self):
        ...
        stack_link = f'https://{REGION}.console.aws.amazon.com/cloudformation/home?region={REGION}#/stacks?filteringText=cloudvelum-autogen-{self.owner}'
        ...
        widgets = [
            {
                ...
                'height': 2,
                'properties': {
                    'markdown': f'![img](https://{PUBLIC_ASSETS_BUCKET}.s3-{REGION}.amazonaws.com/public/cloudvelum/media/{ENVIRONMENT}/dashboard-frontmatter.png)'
                }
            },
            {
                'type': 'text',
                ...
                'properties': {
                    'markdown': (
                        f"[button: View {self.owner.capitalize()}'s CloudVelum Stacks ↗️]({stack_link}) | [button: View CloudVelum Documentation ↗️](http://cloudvelum.1strategy.com)\n"
                        f"#### ⏱ Dashboard was auto generated by CloudVelum at {date_created} \n"
            ...
            },
            {
                ...
                'properties': {
                    'markdown': (
                        ...
                        f'#### 💡 Note: CloudVelum can send email and text notifications when alarms are breached. Make sure you subscribe to keep an eye on your resources.\n'
                        f'#### ✌️ CloudVelum was created by https://1Strategy.com. Reach out to us for support!'
                    )
                }
            }
        ]
